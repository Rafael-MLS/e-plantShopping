...
function ProductList({ onHomeClick }) {
    ...
    // Sync addedToCart state with Redux cart
    useEffect(() => {
    ...
    }, [cart.items]); // Re-run whenever cart items change

    const handleAddToCart = (plant) => {
        dispatch(addItem(plant));
        
        // Update local state to show "Added to Cart" button
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            ...
                            {cart.numOfItems > 0 && <span className="cart-badge">{cart.numOfItems}</span>}
                        </h1>
                    </a></div>
                </div>
            </div>
